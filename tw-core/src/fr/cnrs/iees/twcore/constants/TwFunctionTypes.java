...
// ChangeState: change the state, ie the values of internal variables, of a system component
	ChangeState ("changeState",
		"t,dt,ecosystemPar,ecosystemPop,lifeCyclePar,lifeCyclePop,groupPar,groupPop,limits,focalAuto,focalLtc,focalDrv,focalDec,focalLoc",
...
// ChangeOtherState: _focal_ changes the state of _other_
	ChangeOtherState ("changeOtherState", "t,dt,focal,other", "double,double,SystemComponent,SystemComponent", "void", "otherDrv,otherDec,otherLoc"),
...
// RelateToDecision: _focal_ establishes a new relation to _other_
	RelateToDecision ("relateTo", "t,dt,focal,other,focalLocation,otherLocation", "double,double,SystemComponent,SystemComponent,Location,Location", "boolean", ""),
...
// ChangeRelationState: change the state of a relation
	ChangeRelationState ("changeRelationState", "t,dt,focal,other,relation", "double,double,SystemComponent,SystemComponent,Edge", "void", "focalDrv,focalDec,focalLoc,otherDrv,otherDec,otherLoc"),
...
// SetInitialState: sets the initial state of a newly createdSystemComponent
	SetInitialState ("setInitialState",
		"t,dt,ecosystemPar,ecosystemPop,lifeCyclePar,lifeCyclePop,groupPar,groupPop,limits",
		"double,double,TwData,ComponentContainer,TwData,ComponentContainer,TwData,ComponentContainer,Box",
		"void",
...
// SetOtherInitialStae: sets the initial state of a newly createdSystemComponent given a parent component
	SetOtherInitialState ("setOtherInitialState",
		...
		"void",
		"otherLtc,otherDrv,otherLoc");

	private final String method;
	private final String argumentNames;
	private final String argumentTypes;
	private final String returnType;
	private final String writeableArguments;

	private TwFunctionTypes(String method, String argumentNames, String argumentTypes, String returnType, String writeableArguments) {
		this.method = method;
		this.argumentNames = argumentNames;
		this.argumentTypes = argumentTypes;
		this.returnType = returnType;
		this.writeableArguments = writeableArguments;
	}
	...
	public String writeableArguments() {
		return writeableArguments;
	}
