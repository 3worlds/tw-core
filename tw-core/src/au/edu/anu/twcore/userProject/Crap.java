...
public class Crap {
	...
	public static void main(String[] args) {
		String ppph = "<projectPath>";
		String idph = "<instanceid>";
		String myproject = "Project_crapolla";
		 String userCodeRunnerStr = "public class UserCodeRunner {\n" + //
					"\n" + //
		 ...
		 String contents = ucrStr.replace(ppph, myproject);
