...
public interface TwFunction extends RngHolder {
	...
	public static Collection<TwFunctionTypes> consequenceTypes(TwFunctionTypes func) {
		if (ftypes.isEmpty()) {
			...
			ftypes.put(ChangeCategoryDecision,EnumSet.of(SetOtherInitialState));
			...
			ftypes.put(SetInitialState, EnumSet.noneOf(TwFunctionTypes.class));
			ftypes.put(SetOtherInitialState, EnumSet.noneOf(TwFunctionTypes.class));
		}
