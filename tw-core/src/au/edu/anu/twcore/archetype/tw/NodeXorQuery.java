 ...
 */
public class NodeXorQuery extends Query {

	private String nodeLabel1 = null;
	private String nodeLabel2 = null;
	
	public NodeXorQuery(String nodeLabel1, String nodeLabel2) {
		this.nodeLabel1 = nodeLabel1;
		this.nodeLabel2 = nodeLabel2;
	}
	
	public NodeXorQuery(ObjectTable<?> table) {
		super();
	...
	public String toString() {
		return "[" + stateString() + " There must be at least one node with either label '" + nodeLabel1 + "' or '"+nodeLabel2+"']";
	}
