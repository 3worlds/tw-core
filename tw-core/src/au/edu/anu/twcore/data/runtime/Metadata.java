...
public class Metadata extends OutputData {
	...
	/**
	 * Constructor for a metadata record. The receiver is supposed to know what to do with
	 * the metadata sent.
	 * The constructor works out a unique integer id linked to this instance of Metadata,
	 * which enables to match future output data records to this metadata instance. This
	 * id is accessible through the type() method.
	 * 
	 ...
	 */
	public Metadata(DataTrackerStatus status, 
			int senderId, 
			ReadOnlyPropertyList properties) {
